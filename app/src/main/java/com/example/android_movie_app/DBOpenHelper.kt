...
import com.example.android_movie_app.contracts.CinemaContract
import com.example.android_movie_app.contracts.MovieContract
import com.example.android_movie_app.model.Cinema
import com.example.android_movie_app.model.Movie
import com.example.android_movie_app.model.City
        ...
        try {
            db.execSQL(
                "CREATE TABLE ${MovieContract.Companion.Entry.TABLE}(" +
                        ...
                        "${MovieContract.Companion.Entry.URI} TEXT);"
            )
    ...
    private fun insertMovie(
        ...
        db.execSQL(
            "INSERT INTO ${MovieContract.Companion.Entry.TABLE} (" +
                    ...
                    "${MovieContract.Companion.Entry.URI})" +
                    "values ('${movie.title}','${movie.description}',${movie.imgResId},${movie.duration},${movie.releaseYear},'${movie.country}', '${movie.uri}');"
        )
    }
